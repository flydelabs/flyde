...
describe('resolver', () => {
    ...
    it('resolves a .flyde with dependency on a grouped part from a different package', () => {
        const data = resolveFlow(getFixturePath('a-imports-code-fn-from-package/a.flyde'), 'implementation');
    ...
    it('breaks on invalid schemas', () => {
        ...
        for (const invalid of invalids) {
            ...
            }, /Error parsing/, `File ${invalid} should have failed schema validation`);
        }
    });
