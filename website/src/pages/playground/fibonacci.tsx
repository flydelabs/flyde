...
import { DynamicOutput, dynamicOutput, dynamicPartInput } from "@site/../core/dist";
...
import fiboFlow from './flows/fibonacci.flyde';
...
export default function ReactCounterExample(): JSX.Element {
  ...
  const onCalc = useCallback(() => {
    if (val <= 8 || confirm(`This is an unoptimized Fib. calculator and larger numbers might take a long time to calculate. Are you sure?`)) {
  ...
  return (
    <PlaygroundTemplate meta={META_DATA} flowProps={flowProps} defaultDelay={100}>
      <div className="output-container">
        ...
        <div>
          <input type="number" value={val} max={10} onChange={e => setVal(Number(e.target.value))}/>
