...
declare module "@flyde/core" {
  ...
  export {
    ...
    createInputGroup,
  } from "@flyde/core/improved-macros/improved-macro-utils";
...
declare module "@flyde/core/connect/helpers" {
  ...
  } from "@flyde/core/types/connections";
...
declare module "@flyde/core/common/value-builders" {
  ...
  export const compileStringTemplate: (
    template: string,
    inputs: OMap<any>
  ) => string;
  export const compileObjectTemplate: (
    template: string,
    inputs: OMap<any>
  ) => any;
}
...
declare module "@flyde/core/node/node-pins" {
  ...
  } from "@flyde/core/node/pin-config";
...
declare module "@flyde/core/node/node" {
  ...
  } from "@flyde/core/node/node-instance";
...
declare module "@flyde/core/node/macro-node" {
  ...
  export interface InternalMacroNode<T = any> extends NodeMetadata {
    definitionBuilder: (
      data: T
    ) => Omit<CodeNodeDefinition, "id" | "namespace">;
  ...
  export interface MacroEditorComp<T>
    extends React.FC<MacroEditorCompProps<T>> {}
