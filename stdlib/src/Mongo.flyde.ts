...
export const Find = partFromSimpleFunction({
    ...
    fn: async (connection: MongoClient, collection, query, options) => {
        const result = await connection.db().collection(collection).find(query, options).toArray();
        return result;
    }
});
...
export const FindOne = partFromSimpleFunction({
    ...
    output: {name: 'result', description: ''},
    fn: async (connection: MongoClient, collection, query, options) => {
        const result = await connection.db().collection(collection).findOne(query, options);
        return result;
    }
});
...
export const InsertOne = partFromSimpleFunction({
    ...
    fn: async (connection: MongoClient, collection, document, options) => {
        const result = await connection.db().collection(collection).insertOne(document, options);
        return result;
    }
});
...
export const InsertMany = partFromSimpleFunction({
    ...
    fn: async (connection: MongoClient, collection, documents, options) => {
        const result = await connection.db().collection(collection).insertMany(documents, options);
        return result;
    }
});
...
export const UpdateOne = partFromSimpleFunction({
    ...
    fn: async (connection: MongoClient, collection, filter, update, options) => {
        const result = await connection.db().collection(collection).updateOne(filter, update, options);
        return result;
    }
});
...
export const UpdateMany = partFromSimpleFunction({
    ...
    output: {name: 'result', description: ''},
    fn: async (connection: MongoClient, collection, filter, update, options) => {
        const result = await connection.db().collection(collection).updateMany(filter,update, options);
        return result;
    }
});
...
export const DeleteOne = partFromSimpleFunction({
    ...
    fn: async (connection: MongoClient, collection, filter, options) => {
        const result = await connection.db().collection(collection).deleteOne(filter, options);
        return result;
    }
});
...
export const DeleteMany = partFromSimpleFunction({
    ...
    output: {name: 'result', description: ''},
    fn: async (connection: MongoClient, collection, filter, options) => {
        const result = await connection.db().collection(collection).deleteMany(filter, options);
        return result;
    }
});
...
export const CountDocuments = partFromSimpleFunction({
    ...
    output: {name: 'result', description: ''},
    fn: async (connection: MongoClient, collection, query, options) => {
        const result = await connection.db().collection(collection).countDocuments(query, options);
        return result;
    }
});
...
export const CreateIndex = partFromSimpleFunction({
    ...
    fn: async (connection: MongoClient, collection, fieldOrSpec, options) => {
        const result = await connection.db().collection(collection).createIndex(fieldOrSpec, options);
        return result;
    }
});
...
export const CreateIndexes = partFromSimpleFunction({
    ...
    fn: async (connection: MongoClient, collection, indexes, options) => {
        const result = await connection.db().collection(collection).createIndexes(indexes, options);
        return result;
    }
});
