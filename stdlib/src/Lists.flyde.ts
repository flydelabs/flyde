...
export const ListFrom5 = partFromSimpleFunction({
    ...
    fn: (value1, value2, value3, value4, value5) => [value1, value2, value3, value4, value5]
});
...
export const SplitQuadruple: CodePart = {
    ...
    namespace,
    description: 'Receives a list with 4 items and emits four outputs: the first item, the second item, the third item and the fourth item',
    inputs: {
...
export const AccumulateValuesByTime: CodePart = {
    ...
    inputs: {
        value: {description: 'The value to accumulate'},
        time: {description: 'Time to wait before emitting the accumulated values. Default is 500ms', mode: 'optional'},
    },
...
export const AccumulateValuesByCount: CodePart = {
    ...
    inputs: {
        value: {description: 'The value to accumulate'},
        count: {description: 'Number of values to accumulate before emitting them'},
    },
    reactiveInputs: ['value'],
    outputs: {
        accumulated: {description: 'The accumulated values'},
...
export const Flatten = partFromSimpleFunction({
    ...
    inputs: [
        {name: 'list', description: 'The list of lists'},
    ],
    output: {name: 'list', description: 'The resulting list'},
    fn: (list) => {
