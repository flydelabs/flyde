...
import { getDefaultVisibleInputs } from "../instance-view/InstanceView";
...
export const InstancePanel: React.FC<InstancePanelProps> = (props) => {
  const { instance, part, onChangeInstanceConfig } = props;
  ...
  const onToggleVisible = useCallback(
    (pinId, visible) => {
      const changed = produce(instance, (draft) => {
        const before =
          draft.visibleInputs || getDefaultVisibleInputs(instance, part, props.connections);
    ...
    [instance, onChangeInstanceConfig, part, props.connections]
  );

  const visibleInputs =
    instance.visibleInputs || getDefaultVisibleInputs(instance, part, props.connections);
