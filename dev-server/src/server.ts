...
import { getFlydeDependencies, resolveDependentPackages, scanImportableParts } from './service/scan-importable-parts';
...
export const runDevServer = (port: number, rootDir: string) => {
    ...
    const editorBuildRoot = join(__dirname, '../../integrated-editor/build');
    ...
    setupRemoteDebuggerServer(server, app, () => null, () => null);
