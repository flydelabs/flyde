...
import { DynamicOutput, dynamicOutput, InputMode, OutputPinMap, partInput, partOutput } from './part';
...
export const conciseBasePart = (concise: ConciseBasePart): BasePart => {
  ...
  export const valuePart = (name: string, value: any) => conciseNativePart({
    id: name,
    inputs: [],
    outputs: ['r'],
