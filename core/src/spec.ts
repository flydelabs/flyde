...
describe("main ", () => {
  ...
  describe("core", () => {
    ...
    it("works with nested parts", () => {
      const add1mul2twice = {
        id: "a1m2x2",
        instances: [partInstance("p1", add1mul2), partInstance("p2", add1mul2)],
        connections: [
          {
        ...
        const part = connect(
          {
            id: "bob",
            instances: [
              partInstance("b", Value(5)),
              partInstance("v", Value(42)),
              partInstance("a", optAdd),
            ],
            connections: [
    ...
    describe("connect", () => {
      ...
      it("connects one-off inputs properly", () => {
        ...
        const part = connect(
          {
            id: "test",
            instances: [partInstance("v1", Value(n)), partInstance("a", add1)],
            connections: [
              {
      ...
      it("connects the same output to 2 inputs", () => {
        ...
        const part = connect(
          {
            id: "test",
            instances: [partInstance("v", Value(n)), partInstance("a", add)],
            connections: [
              {
      ...
      it("works regardless of the order of the instances and connections with 2 pieces", () => {
        const n = randomInt(99);
        const repo = testRepoWith(Value(n));
        const instances = [partInstance("a", add1), partInstance("v", Value(n))];
      ...
      it("works regardless of the order of the instances and connections with 3 pieces", () => {
        ...
        const instances: PartInstance[] = [
          partInstance("a", add),
          partInstance("v1", Value(n)),
          partInstance("v2", Value(n)),
        ];
    ...
    it("supports constant values on connect", () => {
      ...
      const part = connect(
        {
          id: "test",
          instances: [partInstance("v", Value(7)), partInstance("a", add)],
          connections: [
            connectionData("v.r", "a.n1"),
            connectionData("n2", "a.n2"),
            connectionData("a.r", "r"),
    ...
    it("supports static values on raw", () => {
      ...
      const part = connect(
        {
          id: "test",
          instances: [partInstance("v", Value(7)), partInstance("a", transform)],
          connections: [
    ...
    describe("stopping execution", () => {
      ...
      it("stops running connected components", () => {
        ...
        const part = connect(
          {
            id: "bob",
            instances: [partInstance("a", ids), partInstance("b", ids)],
            connections: [
              {
                from: connectionNode("a", "r"),
    ...
    it("allows same name for input and output", () => {
      ...
      const part: GroupedPart = {
        ...
        instances: [partInstance("v", Value(1)), partInstance("add", add)],
        connections: [
    ...
    describe("more than 1 connection per pin", () => {
      ...
      it("returns all given pulses to output", async () => {
        ...
        const part: GroupedPart = {
          ...
          inputsPosition: {},
          outputsPosition: {},
          instances: [partInstance("a", Value(1)), partInstance("b", Value(2))],
          connections: [
            connection(connectionNode("a", "r"), externalConnectionNode("r")),
    ...
    describe("part state", () => {
      ...
      it("cleans inner inputs state after part is executed - no completion", () => {
        ...
        const part = concisePart({
          ...
          instances: [
            partInstance("i1", add),
            partInstance("i2", id), // id to simualte anot
          ],
          connections: [
            ["n1", "i1.n1"],
            ["n2", "i1.n2"],
      ...
      it("cleans internal state of parts after execution", () => {
        ...
        */
        ...
        const counterWrapper = concisePart({
          ...
          inputs: ["v"],
          outputs: ["r"],
          instances: [partInstance("i1", counter)],
          connections: [
            ["v", "i1.v"],
            ["i1.r", "r"],
          ],
      ...
      it("does not clean internal of parts after execution until parent is not done", () => {
        ...
        */
        ...
        const counterWrapper = concisePart({
          ...
          outputs: ["r", "r2"],
          reactiveInputs: ["v", "v2"],
          instances: [partInstance("i1", counter), partInstance("i2", id)],
          connections: [
            ["v", "i1.v"],
            ["i1.r", "r"],
            ["v2", "i2.v"],
    ...
    it("runs parts that are not fully connected", () => {
      const part: GroupedPart = {
        ...
        instances: [partInstance("p1", id), partInstance("p2", add)],
  ...
  describe("uncontrolled grouped parts", () => {
    it("waits for all inputs when grouped part is uncontrolled", () => {
      ...
      const grouped: GroupedPart = {
        ...
        outputs: {},
        instances: [partInstance("i", innerPart)],
        connections: [],
        inputsPosition: {},
        outputsPosition: {},
      };
  ...
  describe("recursion support", () => {
    ...
    it('support recursive "add" calculation', () => {
      const addRec: GroupedPart = {
        ...
        outputsPosition: {},
        instances: [
          partInstance("if", peq, { compare: staticInputPinConfig(0) }),
          partInstance("arr", "add-rec"),
          partInstance("add1", add, { n2: staticInputPinConfig(-1) }),
          partInstance("add2", add, { n2: staticInputPinConfig(1) }),
    ...
    it("support recursion based factorial calculation", () => {
      ...
      const fact: GroupedPart = {
        ...
        instances: [
          ...
          partInstance("if", peq, { compare: staticInputPinConfig(0) }),
          partInstance("f", "fact"),
          partInstance("add", add, { n2: staticInputPinConfig(-1) }),
          partInstance("mul", mul),
          partInstance("tr1", transform.id, { to: staticInputPinConfig(1) }),
        ],
        connections: [
          connectionData("n", "if.val"),
  ...
  describe("const values", () => {
    ...
    it("supports const values defined inside grouped parts", () => {
      ...
      const part = concisePart({
        ...
        inputs: ["n1"],
        outputs: ["r"],
        instances: [partInstance("a", add, { n2: staticInputPinConfig(n2) })],
        connections: [
          ["n1", "a.n1"],
          ["a.r", "r"],
        ],
    ...
    describe("accumulate", () => {
      ...
      it("allows creating accumulate2 visually (shared state)", () => {
        const groupedPart = concisePart({
          ...
          completionOutputs: ["r"],
          reactiveInputs: ["val"],
          instances: [partInstance("i1", accumulate, { count: staticInputPinConfig(2) })],
          connections: [
            ["val", "i1.item"],
            ["i1.r", "r"],
          ],
      ...
      it("accumulate2 visually cleans up state properly after it is done", () => {
        const groupedPart = concisePart({
          ...
          outputs: ["r"],
          reactiveInputs: ["val"],
          instances: [partInstance("i1", accumulate, {})],
          connections: [
            ["val", "i1.item"],
            ["count", "i1.count"],
            ["i1.r", "r"],
  ...
  describe("error handling", () => {
    ...
    it("reports uncaught errors that happened on an internal part", async () => {
      ...
      const badWrapper = concisePart({
        ...
        inputs: ["a"],
        outputs: ["r"],
        instances: [partInstance("i1", badPart)],
        connections: [["a", "i1.a"]],
      });
  ...
  describe("bugs found", () => {
    ...
    it("works with spreading a 3 arrayed list into an accumulate 1", () => {
      ...
      const part = concisePart({
        ...
        outputs: ["r"],
        instances: [
          partInstance("i1", spreadList),
          partInstance("i2", accumulate, { count: staticInputPinConfig(1) }),
        ],
        connections: [
          ["list", "i1.list"],
          ["i1.val", "i2.val"],
  ...
  describe("environment vars", () => {
    ...
    it("supports reading non string env variables", async () => {
      const groupedId = concisePart({
        ...
        outputs: ["r"],
        connections: [["i1.r", "r"]],
        instances: [partInstance("i1", id, { v: staticInputPinConfig("$ENV.aValue") })],
      });
    ...
    it("supports reading properties from objects in env", async () => {
      const groupedId = concisePart({
        ...
        outputs: ["r"],
        connections: [["i1.r", "r"]],
        instances: [partInstance("i1", id, { v: staticInputPinConfig("$ENV.myObj.student.name") })],
      });
  ...
  describe('misc', () => {
    it.only('does not clean state when reactive input is received', () => {
      const part = conciseNativePart({
        id: 'part',
        inputs: ['a'],
        outputs: ['r'],
